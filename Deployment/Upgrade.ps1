...
dotnet publish ../AdminSite/AdminSite.csproj -v q -c debug -o ../Publish/AdminSite/
Write-host "## Admin Portal built" 
dotnet publish ../MeteredTriggerJob/MeteredTriggerJob.csproj -v q -c debug -o ../Publish/AdminSite/app_data/jobs/triggered/MeteredTriggerJob --runtime win-x64 --self-contained true 
Write-host "## Metered Scheduler to Admin Portal Built"
dotnet publish ../CustomerSite/CustomerSite.csproj -v q -c debug -o ../Publish/CustomerSite
